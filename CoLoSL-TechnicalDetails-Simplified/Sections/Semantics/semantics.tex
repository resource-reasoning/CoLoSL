...
\]
%
The \emph{flattenig} function $\un{.} : \Assertions \rightarrow \FAssertions$ is defined inductively as follows where $x$ does not appear free in $I$ and $\odot \in \{\land, \lor, *, \sepish\}$. 
%
\begin{align*}
	\un{A} \eqdef & A\\
%
	\un{P \odot Q} \eqdef & \un{P} \odot \un{Q}  \quad \text{for } \\
%
...
%
\begin{align*}
	B ::= \emp \mid \shared{P}{I} \mid B \odot B
	\quad
