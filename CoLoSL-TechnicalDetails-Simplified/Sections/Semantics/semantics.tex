...
%	
	...
	\infer{
		\stableIn{\lass{P}}{\left\{\capAss{}: Q_1 \swap Q_2 \right\}} {\fass{R}}	
	}
	{
		\combine{\fass{R}}{Q_1} \slentails \m{false}
	}
	...
	{
		\left(\erase{Q_1} \septraction \combine{\fass{R}}{Q_1} \,\right) * \erase{Q_2} \slentails \lass{P} * \m{true}
	}
...
\hrule
%\vspace*{5pt}
\caption{Stability judgements where $P, Q_1, Q_2 \in \Assertions$; $\fass{P}, \fass{Q}, \fass{R} \in \FAssertions$; and $\lass{P} \in \LAssertions$.}
