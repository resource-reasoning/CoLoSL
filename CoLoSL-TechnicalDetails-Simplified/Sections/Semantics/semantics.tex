...
\begin{mathpar}
	...
	}
	{
		\fenceAss{}' |- \fenceAss{}
		&
		\fenceAss{} \sepish P |- \fenceAss{}' \sepish P
		&
		\fenceAss{}' \strictfences \left\{\capAss{}: P \swap Q \right\}		
	}
...
%
	...
	}
	{
		P \cap Q |- \emp	
		&
		\left(P \septraction \fenceAss{} \sepish P \right) * Q |- \fenceAss{}
	}
	...
	}
	{
		\fenceAss{}' |- \fenceAss{}
		&
		P \sepish \fenceAss{} |- P \sepish \fenceAss{}'
		&
		\fenceAss{}' \fences \left\{\capAss{}: P \swap Q \right\}		
	}
...
%		& \fenceAss{} \fences  \left\{ \capAss{}: \left\{ P \swap Q \right\}\right\}
		\left(P \septraction (P \sepish \fenceAss{})\right) * Q \entails \m{false}
	}
...
\begin{mathpar}
	...
	\infer{
		\stableIn{P}{\left\{\interAss{\capAss{}}{\bar{y}}{Q_1}{Q_2}\right\}}{R}	
	}
	{
		\capAss{} * R |- \m{false}
	}
	...
	\infer{
		\stableIn{P}{\left\{\capAss{}: Q_1 \swap Q_2 \right\}} {R}	
	}
	{
		P * Q_1 |- \m{false}
	}
	...
	{
		\left(Q_1 \septraction (Q_1 \sepish P)\right) * Q_2 |- P * \m{true}
	}
