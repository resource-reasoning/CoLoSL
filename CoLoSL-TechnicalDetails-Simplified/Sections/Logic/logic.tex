...
\begin{array}{R>{\null}l@{\ \,}c@{\ \,}l}
  ...
  w, \lenv &|= P --* Q &\text{iff}&
   \for{w'} w', \lenv |= P \text{ and }  w \compatible w'\\
...
\begin{array}{R>{\null}l@{\ \,}c@{\ \,}l}
  ...
  s, \lenv &|=_\dagger P --* Q &\text{iff}&
  \for{s'} s', \lenv |=_\dagger P \text{ and }
  s \compatible s'\\
...
%\begin{array}{R>{\null}l@{\ \,}c@{\ \,}l} 
  ...
  l, \lenv & \slsat P --* Q &\text{iff}&
  \for{l'} l', \lenv \slsat P \text{ and }
  l \compatible l'\\
...
%  \hfill \text{(3)}  \null\\
  ...
  \left(
  \begin{array}{l}
  	\m{reflected}(a,s\composeL r,\lmod'(\ca{})) /| \hfill \text{(2)}\\
	  \for{(s', r') \in a[s, r]} \extendsAMUpto{\lmod}{n}{s'}{r'}{\lmod'} \qquad \hfill \text{(3)}
	  \end{array}
  \right) |/\null\\
  
  \qquad \left(\neg\m{visible}(a,s) /| \for{(s', r') \in a[s, r]} \extendsAMUpto{\lmod}{n}{s'}{r'}{\lmod'} \right) \qquad\hfill \text{(3)}
