...
%	\end{array}\\
	...
	\hspace*{0.2cm}\for{\ca{}} \for{l \in F}  \for{f, r, p, q, r'} (\for{s} s \leq p \land s \leq q \implies s = \unitL) \implies\\
	\hspace*{0.2cm}
	\begin{array}{l}
...
\begin{array}{r l}
	...
	\repartitions{W_1}{W_2}{\Hp{1}}{\Hp{2}} \iffdef &
	\begin{array}{l}
		\for{w_1 \in W_1} \exsts{\h{1} \in \Hp{1}\ , \h{}'}\\
		\hspace*{0.5cm} \h{1} \composeH \h{}' = \heapPart{(\collapseW{w_1})} \;\land\\
		\hspace*{0.5cm} \for{\h{2} \in \Hp{2}} \exsts{w_2 \in W_2}\\
		\hspace*{1cm} \h{2} \composeH \h{}' = \heapPart{(\collapseW{w_2})} \;\land\; (w_1, w_2) \in \guarantee
	\end{array}
\end{array}
\]
%
...
%	
%%	\for{l_1,\cdots,l_n \in \LStates}\for{\amod{1},\cdots,\amod{n} \in \AMods}\for{F_1, \cdots,F_n \in \pset{\LStates}}\\
%%	
