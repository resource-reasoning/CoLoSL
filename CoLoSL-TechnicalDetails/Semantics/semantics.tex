...
%			\for{l_1, r_1, \amod{1}} l_1 \composeL r_1 = s \land \extendsAM{\amod{}}{l_1}{r_1}{\amod{1}}  \\
%			\hspace*{1cm} \implies\extendsAM{\amod{}'}{l_1}{r_1 \composeL s'}{\amod{1}}		
%		
%		
%			\exsts{K, \amod{0}} \dom{\amod{0}} \subseteq K\\
%			
%			\land\; \dom{K} \cap \amod{} = \emptyset\\
%			
%			\land\; \exsts{\fence{}} s' \in \fence{} \;\land\; \fence{} \strictfences \amod{0} \\
%			\land\; \contains{K \cup \dom{\amod{}}}{\capPart{s'}} \\
%						
%     	\land\;  \extendsAM{\amod{}'}{s}{s'}{\amod{}} \;\land\;
%			\extendsAM{\amod{}'}{s'}{s}{\amod{0}} \\
