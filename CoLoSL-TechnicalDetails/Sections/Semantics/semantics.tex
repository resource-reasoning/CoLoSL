...
%	= \opSemSeq{\seq{}}{\reifyW{W_1 \composeW \{w\}}} \\
%	
%	
%	
%	\left( \text{from } (\ref{TA:Ass1}) \right)  & =
%	\opSemSeq{\seq{}}{
%		\left\{
%		\begin{array}{@{} l @{\hspace{3pt}} | @{\hspace{3pt}} l @{}}
%			\reifyW{\left(l \composeL \localPart{w}, g, \lmod, \gmod \right)}
%			&
%			\begin{array}{@{} l @{} }
%				(l, g, \lmod, \gmod) \in W_1 \\ 
%				(\Hp{1}, \seq{}, \Hp{2}) \in \AxiomsSeq \\
%				\repartitions{W_1}{W_2}{\Hp{1}}{\Hp{2}}
%			\end{array}			
%		\end{array}
%		\right\}
%	}\\
...
%				(\Hp{1}, \seq{}, \Hp{2}) \in \AxiomsSeq \\
%				\repartitions{W_1}{W_2}{\Hp{1}}{\Hp{2}}\\
%				\h{1} \composeH \h{}' = \heapPart{l} \composeH \heapPart{g}\\
%				\h{1} \in \Hp{1}
%			\end{array}			
%		\end{array}
%		\right\}
...
%	
%	
%	\left(\text{\lem}~\ref{lem:seqSoundness} \right)
%	& \subseteq
%	\left\{
%	\hspace*{-0.15cm}
%	\begin{array}{l | l}
...
%	
%	
%	\left(\text{\lem}~\ref{lem:guaranteeContainment} \right)
%	& 
