...
From (\ref{extend:Ass8}), (\ref{extend:Ass9}), the definitions of $\lmod_{e}$, $\gmod'$, $g'$ and \lem~\ref{lem:extend-closure}, we can despatch this obligation.\\

%(\ref{extend:Ass})
\noindent\textbf{RTS. (\ref{extend:Goal5})}
From (\ref{extend:Ass8}), (\ref{extend:Ass9}), the definitions of $\lmod_{e}$, $\gmod'$, $g'$ and \lem~\ref{lem:extend-closure-2}, we can despatch this obligation.\\
...
\end{align}
%(\ref{extend:Ass})
On the other hand, from (\ref{extend:Ass8}), (\ref{extend:Ass9}), the definitions of $\lmod_{e}$, $\gmod'$, $g'$,  \lem~\ref{lem:extend-closure} and since $\lmod' = \lmod'' \cup \lmod_0 = \semI[\lenv]{I[\vec{v}/\vec{x}]} \cup \lmod_0$, we have:
%
\begin{align}
...
\[
\begin{array}{@{} l @{}}
	(s, g, \lmod, \gmod), \lenv |= P /| \expandsAM{\gmod'}{s}{\lmod'}{g}{\lmod}{\gmod} 
...
%
\begin{align}
	& (s, g, \lmod, \gmod), \lenv |= P_1 \implies P_2 \label{subextend:Ass1}\\
%	
	& \expandsAM{\gmod'}{s}{\lmod'}{g}{\lmod}{\gmod} \label{subextend:Ass2}\\
%	
	& \for{s, g \in \LStates} \for{\lmod, \lmod', \gmod, \gmod' \in \AMods} \nonumber\\
	\tag{I.H1} & \quad (s, g, \lmod, \gmod), \lenv |= P_1 /| \expandsAM{\gmod'}{s}{\lmod'}{g}{\lmod}{\gmod} 
	\implies s, \lenv |=_{g \composeL s, \lmod \cup \lmod', \gmod'} P_1
	\label{subextend:IH1}\\ 
%
	& \for{s, g \in \LStates} \for{\lmod, \lmod', \gmod, \gmod' \in \AMods} \nonumber\\
	\tag{I.H2} & \quad (s, g, \lmod, \gmod), \lenv |= P_2 /| \expandsAM{\gmod'}{s}{\lmod'}{g}{\lmod}{\gmod} 
	\implies s, \lenv |=_{g \composeL s, \lmod \cup \lmod', \gmod'} P_2
	\label{subextend:IH2}
%	
\end{align}
%
From (\ref{subextend:Ass1}) and the definition of $|=$ we know $(s, g, \lmod, \gmod), \lenv |= P_1$ \text{ implies } $(s, g, \lmod, \gmod), \lenv |= P_2$; consequently, from (\ref{subextend:Ass2}), (\ref{subextend:IH1}) and (\ref{subextend:IH2}) we have: $s, \lenv |=_{g \composeL s, \lmod \cup \lmod', \gmod'} P_1$ \text{ implies } $s, \lenv |=_{g \composeL s, \lmod \cup \lmod', \gmod'} P_2$. Thus, from the definition of $|=_{g \composeL s, \lmod \cup \lmod', \gmod'}$ we have:
%
\begin{align*}
	s, \lenv |=_{g \composeL s, \lmod \cup \lmod', \gmod'} P_1 \implies P_2
\end{align*}
%
as required.\\
...
\begin{array}{@{} l @{}}
	...
	\expandsAM{\gmod'}{\unitL}{\lmod'}{g}{\lmod}{\gmod}
%	\left(\for{s', \lmod_0} \extendsAM{\lmod, \gmod}{s'}{g-s'}{\lmod_0} \!\!\!\implies\!\!\! \extendsAM{\lmod \cup \lmod', \gmod'}{s'}{g-s'}{\lmod_0} \right)   \\
