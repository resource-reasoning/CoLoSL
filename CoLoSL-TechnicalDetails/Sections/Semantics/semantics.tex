...
%
\begin{proof}
From the definition of $\extendR$, it then suffices to show that for all $P \in \Assertions$, $\lenv \in \LEnv$, $l, g, g' \in \LStates$ and $\lmod, \lmod', \gmod, \gmod' \in \AMods$: 
% 
\[
\begin{array}{@{} l @{}}
...
%	\left(\for{s', \lmod_0} \extendsAM{\lmod, \gmod}{s'}{g-s'}{\lmod_0} \!\!\!\implies\!\!\! \extendsAM{\lmod \cup \lmod', \gmod'}{s'}{g-s'}{\lmod_0} \right)   \\
	 \implies  (l, g \composeL g', \lmod \cup \lmod', \gmod'), \lenv |= P
\end{array}
\]
%
