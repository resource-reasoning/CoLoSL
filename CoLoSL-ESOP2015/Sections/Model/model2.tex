...
In what follows, we will use the following standard terminology.
...
\end{mathpar}
\hrule
\caption{Confinement and local fencing rules.}
...
report~\cite{colosl-tr}. The main part of the proof is to establish
...
\begin{definition}[Valid triple]
  ...
  \[
    \left(w, \lenv |= P  \land \h{} \in \reifyW{w} \land \mathbb{C}, \h{} \rightarrow^{\text{*}} \li{skip}, \h{}'\right)
    \text{ implies } \exsts{w'} w', \lenv |= Q \land \h{}' \in \reifyW{w'}
  \]
\end{definition}
