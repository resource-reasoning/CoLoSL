...
%
\azaleacomment{Include the size function.}
%
\paragraph{Stability}
...
%
%
\begin{definition}[Compatible Frames]\label{def:compatibleFrames}
The \emph{compatible frames} of a heap  $\heapSize{.}: \Heaps \rightarrow \pset{\Heaps}$ is defined as the set of all heaps that are disjoint from it. That is, given a heap $m \in \Heaps$:
%
\[
