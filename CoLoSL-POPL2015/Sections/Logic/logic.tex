...
%  &&\cdots\\
  ...
  \text{ iff } l = \unitL\\
  s, \lenv &|=_{g,\lmod,\gmod} \p{A} &\text{iff}& s, \lenv \slsat \p{A}\\
...
\[
\begin{array}{R>{\null}l@{\ \,}c@{\ \,}l}
  (l,g,\lmod,\gmod), \lenv &|= \p{A} &\text{iff}& l,\lenv \slsat \p{A}\\
