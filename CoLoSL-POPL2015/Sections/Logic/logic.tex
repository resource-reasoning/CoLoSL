...
previous section.\\
\azaleaComment{The overlap connective $\intersect$ is new. We should explain that.}
\azaleaComment{Why $--*$ and not $\ewand$?}
...
\julescomment{Or maybe we just need the partial abelian monoid
...
\begin{definition}[Assertion Semantics]
  ...
  \defin~\ref{def:interferenceSemantics}.
\begin{align*}
  \intermediateSem{\emp} 
  &  \eqdef
...
%	
%	\begin{array}{l | l}
%		(p \composeL q, s, \amod{}, \amod{\ell})& 
%		\begin{array}{@{}l@{}}
%				 (p, s, \amod{}, \amod{\ell}) \in \intermediateSem{P} \land\null\\
%				 (q, s, \amod{}, \amod{\ell}) \in \intermediateSem{Q} 
%		\end{array}
%		
%	\end{array} 
%	
%	\right\}\\
	...
	\end{array}
      \end{array} 
      \right\}\\
      %% \intermediateSem{P_1 \intersect P_2} 
      %% &  \eqdef
      %% \left\{ 
      %% \begin{array}{@{}l@{\ }|@{\ }l@{}}
      %%   (l, s, \amod{}, \amod{\ell}) & 
      %%   \begin{array}{@{}l@{}}
      %%     \exsts{l_1,l_2} (l \composeL l_1, s, \amod{}, \amod{\ell}) \in \intermediateSem{P_1}\land\null \\
      %%     \quad(l \composeL l_2 , s, \amod{}, \amod{\ell}) \in \intermediateSem{P_2} 
      %%   \end{array}
      %% \end{array} 
      %% \right\}\\
...
Note that, according to our semantics, nested subjective views behave
...
\]
%
\azaleaComment{Why does it need to be a $\biguplus$ as opposed to $\bigcup$?}
\end{definition}
%
%
%
