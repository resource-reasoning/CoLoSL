...
We are now ready to formalise well-formedness. A capability $\ca{}$
...
\julescomment{We should have a definition instanciated with sets of
  tokens here.}
...
\begin{array}{l l l}
	...
	\hspace*{-0.2cm} & \hspace*{-0.2cm} 
	& \hspace*{-0.1cm} 	
	\null\land \contains{\dom{\amod{\ell}}}{\ca{}}
\end{array}
\]
\end{definition}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Local and global action models}
