...
\item
  ...
  pre-state is fully contained in $g$ is reflected is $\gmod$;
\item
...
\julescomment{We don't actually use the below, do we? If not, probably
  needs to be removed.}
...
using $\slsat$ and explicitly unpack such predicates and erase their
subjective views.
