...
\azaleacomment{I think we agreed that stability does not imply being fenced. The above statement is wrong!}
\azaleacomment{In future when making a change can you comment my stuff out rather than deleting them? It is time consuming to go back and forth between revisions to remember what I had. :(}
