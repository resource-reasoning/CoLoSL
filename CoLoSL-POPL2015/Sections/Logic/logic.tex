	...
	\for{\kappa} \semI[\lenv]{I}(\ca{}) ==
		...
		\begin{array}{@{}l@{\ }|@{\ }r@{}}
			...
			\begin{array}{@{}l@{}}
				...
				\quad\ca{} \in \semK[\lenv]{\capAss{}} \land\null\\
				\quad(p, -, -, -) \in \intermediateSem[\lenv\text{[} \vec{y} \mapsto \vec{v} \text{]}]{P} \land\null\\
				\quad(q, -, -, -) \in \intermediateSem[\lenv\text{[} \vec{y} \mapsto \vec{v} \text{]}]{Q} 
			\end{array}
		\end{array}
	\right\}
\]
