...
\S\ref{sec:examples}. First, consider the program $\mathbb{INC}$ defined
...
intertwinned. For example, the thread $\mathbb{P}_y$
...
\pgcomment{Are we doing variables as resource? I guess so given first
  assertion?
