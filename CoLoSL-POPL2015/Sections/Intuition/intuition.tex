...
\copyRule/\mergeRule\ principle for subjective views, we obtain a  precondition for thread $\mathbb{P}_{\li y}$:
\[
...
from $I$, the resulting subjective view remains unaffected by $\token a_{\li z}$. Using the \shiftRule principle, we
