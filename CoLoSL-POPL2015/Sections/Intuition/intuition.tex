...
contructs for concurrency: atomic sections $\atomic \_$ which
...
assertion from separation logic~\cite{.} with variables as
resource~\cite{.}. The assertion  declares  that the variable cells
addressed by 
\li{x},
