...
Finally, as is normal when reasoning about concurrency, we stabilise so
...
Let  $I_{\li y}' $ be  $I$ with $\token a_{\li x}$ rewritten as above.
...
\shiftRule\ principle to change  the interference
relation to $I_{\li y} = I'_{\li y} \backslash \token a_{\li z}$. The interference relation
