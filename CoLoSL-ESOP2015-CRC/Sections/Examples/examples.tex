...
To understand why that is, let us look at the interference associated
...
of each local view concerning a vertex $n \in \gamma$ has been shifted
...
Let us define
\begin{align*}
	P(x,@g) &\eqdef \iterStar_{x\leadsto^{*}_\gamma n} \left( \exsts{l,r}\gamma(n) = (l, r) \land (\unmarked{n}{l}{r} \lor \marked{n}) \; \right)\\
	Q(x,@g) &\eqdef \iterStar_{x\leadsto^{*}_\gamma n} \left( \exsts{l,r}\gamma(n) = (l, r)
