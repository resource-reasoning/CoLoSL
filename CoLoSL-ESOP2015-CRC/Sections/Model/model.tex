...
\pgcomment{Now you've previously talked about catalyst using the $s_x$
  example from figure 2. Would it be possible to use this rather than
  examples below? It would be better if you can, using this spawner
  idea? Too hard? Maybe it illustrates the transitivity of
  confinement?}
