...
$\mathbb{MASTER}\mid\mid\mathbb{FOREMAN}\mid\mid\mathbb{SLAVE}$;
//$\color{blue}\left\{\begin{array}{@{}l@{}}\tx{x}_0|-< x_0 * \tx{x}_1|-< x_1 *\tx{x}_2|-< x_2 *\null\\ * [\token m_{x_0}] * [\token s_{x_1}] * [\token s_{x_2}]*\null\\ \shared{\begin{array}{@{}l@{}}x_0|->10,x_2 * x_1|->10,x_0 *\null\\ x_2|->10,x_1\end{array}}{I}\end{array} \right\}$
\end{lstlisting}}
&
\begin{lstlisting}
//$\color{blue} \{\varcell{\tx x_0}{x_0} * \shared{\cell{x_0}{0,x_2} * \cell{x_2}{0}}{M_{x_0}'} * [\token m_{x_0}]\}$
while(x$_0$-$\!\textgreater$c != 10)
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_0}{x_0} * [\token m_{x_0}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{v}\cell{x_0}{v,x_2} * \cell{x_2}{v} \lor\null\\ \quad\cell{x_0}{v+1,x_2} * \cell{x_2}{v}\end{array}}{M_{x_0}'}\end{array} \right\}$
  $\{\ \langle$if (x$_0$-$\!\textgreater$c == x$_0$-$\!\textgreater$p-$\!\textgreater$c) (x$_0$-$\!\textgreater$c)++;$\rangle\ \}$
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_0}{x_0} * [\token m_{x_0}]*\null\\\shared{\begin{array}{@{}l@{}}\cell{x_0}{10,x_2} * \cell{x_2}{10} \lor\null\\ \quad\cell{x_0}{10,x_2} * \cell{x_2}{9}\end{array}}{M_{x_0}'}\end{array} \right\}$
\end{lstlisting}
\\
$\mathbb{FOREMAN}$:&
{$\mathbb{SLAVE}$:}
\vspace{-5pt}\\
\begin{lstlisting}
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_1}{x_1} * [\token s_{x_1}]*\null\\\shared{\begin{array}{@{}l@{}}\cell{x_1}{0,x_0} * \cell{x_0}{0} \lor\null\\ \quad\cell{x_1}{1,x_0} * \cell{x_0}{0}\end{array}}{F_{x_1}'}\end{array} \right\}$
 while(x$_1$-$\!\textgreater$c != 10)
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_1}{x_1} * [\token s_{x_1}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{v}\cell{x_1}{v,x_0} * \cell{x_0}{v} \lor\null\\ \quad\cell{x_1}{v,x_0} * \cell{x_0}{v+1}\end{array}}{F_{x_1}'}\end{array} \right\}$
  $\{\ \langle$if (x$_1$-$\!\textgreater$c != x$_1$-$\!\textgreater$p-$\!\textgreater$c)
     x$_1$-$\!\textgreater$c = x$_1$-$\!\textgreater$p-$\!\textgreater$c;$\rangle\ \}$
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_1}{x_1} * [\token s_{x_1}]*\null\\\shared{\begin{array}{@{}l@{}}\cell{x_1}{10,x_0} * \cell{x_0}{10} \lor\null\\ \quad\cell{x_1}{10,x_0} * \cell{x_0}{11}\end{array}}{F_{x_1}'}\end{array} \right\}$
\end{lstlisting}
&
\begin{lstlisting}
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_2}{x_2} * [\token s_{x_2}]*\null\\\shared{\begin{array}{@{}l@{}}\cell{x_2}{0,x_1} * \cell{x_1}{0} \lor\null\\ \quad\cell{x_2}{1,x_1} * \cell{x_1}{0}\end{array}}{S_{x_2}'}\end{array} \right\}$
 while(x$_2$-$\!\textgreater$c != 10)
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_2}{x_2} * [\token s_{x_2}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{v}\cell{x_2}{v,x_1} * \cell{x_1}{v} \lor\null\\ \quad\cell{x_2}{v,x_1} * \cell{x_1}{v+1}\end{array}}{S_{x_2}'}\end{array} \right\}$
  $\{\ \langle$if (x$_2$-$\!\textgreater$c != x$_2$-$\!\textgreater$p-$\!\textgreater$c)
     x$_2$-$\!\textgreater$c = x$_2$-$\!\textgreater$p-$\!\textgreater$c;$\rangle\ \}$
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_2}{x_2} * [\token s_{x_2}]*\null\\\shared{\begin{array}{@{}l@{}}\cell{x_2}{10,x_1} * \cell{x_1}{10} \lor\null\\ \quad\cell{x_2}{10,x_1} * \cell{x_1}{11}\end{array}}{S_{x_2}'}\end{array} \right\}$
\end{lstlisting}
\end{tabular}
\[
\begin{array}{@{}r@{}l@{}l@{}}
...
{\begin{lstlisting}
spawn() $\{$
//$\color{blue} \left\{\begin{array}{@{}l@{}}\exsts p \tx{x}_0|-< x_0 * [\token e_{x_0}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{v} \cell{x_0}{v,p} * \cell{p}{v} \lor\null\\ \quad\cell{x_0}{v+1,p} * \cell{p}{v}\end{array}}{E}\end{array} \right\}$
  local x;
//$\color{blue} \left\{\begin{array}{@{}l@{}}\tx{x}_0|-< x_0 * \varcell{\tx x}{-} * [\token e_{x_0}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{v} \cell{x_0}{v,p} * \cell{p}{v} \lor\null\\ \quad\cell{x_0}{v+1,p} * \cell{p}{v}\end{array}}{E}\end{array} \right\}$
  x = new();
  x-$\!\textgreater$p = x$_0$-$\!\textgreater$p;
//$\color{blue} \left\{\begin{array}{@{}l@{}}\tx{x}_0|-< x_0 * \varcell{\tx x}{x} * x|->-,p * [\token e_{x_0}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{v} \cell{x_0}{v,p} * \cell{p}{v} \lor\null\\ \quad\cell{x_0}{v+1,p} * \cell{p}{v}\end{array}}{E}\end{array} \right\}$
  $\langle$x-$\!\textgreater$c = x$_0$-$\!\textgreater$c - 1;
   x$_0$-$\!\textgreater$p = x;$\rangle$
//$\color{blue} \left\{\begin{array}{@{}l@{}}\tx{x}_0|-< x_0 * \varcell{\tx x}{x} * [\token s_{x}] * [\token e_{x_0}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{v} \cell{x_0}{v,x} * x|->v-1,p * \cell{p}{v} \lor\null\\ \quad\cell{x_0}{v+1,x} * x|->v,p * \cell{p}{v}\end{array}}{E}\end{array} \right\}$
  $\mathbb{SLAVE}[x_2\leftarrow x, x_1\leftarrow p]\ \mid\mid$ spawn();
$\}$
\end{lstlisting}}
&
\begin{lstlisting}
//$\color{blue} \{\varcell{\tx x_0}{x_0} * \shared{\begin{array}{@{}l@{}}\E{p}\cell{x_0}{0,p} * \cell{p}{0}\lor\null\\\cell{x_0}{0,p} * \cell{p}{-1}\end{array}}{M_{x_0}''} * [\token m_{x_0}]\}$
while(x$_0$-$\!\textgreater$c != 10)
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_0}{x_0} * [\token m_{x_0}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{p,v}\cell{x_0}{v,p} * \cell{p}{v} \lor\null\\ \quad\cell{x_0}{v+1,p} * \cell{p}{v}\end{array}}{M_{x_0}''}\end{array} \right\}$
  $\{\ \langle$if (x$_0$-$\!\textgreater$c == x$_0$-$\!\textgreater$p-$\!\textgreater$c) (x$_0$-$\!\textgreater$c)++;$\rangle\ \}$
//$\color{blue} \left\{\begin{array}{@{}l@{}}\varcell{\tx x_0}{x_0} * [\token m_{x_0}]*\null\\\shared{\begin{array}{@{}l@{}}\exsts{p}\cell{x_0}{10,p} * \cell{p}{10} \lor\null\\ \quad\cell{x_0}{10,p} * \cell{p}{9}\end{array}}{M_{x_0}''}\end{array} \right\}$
\end{lstlisting}
\end{tabular}
