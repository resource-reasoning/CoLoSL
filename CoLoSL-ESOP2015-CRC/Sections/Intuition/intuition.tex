...
We can thus replace $S_x$ by $S'_x$ and give a stronger precondition that captures just
...
loop and the postcondition are also stable. The atomic section performs
