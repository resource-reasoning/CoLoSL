...
captures  just these two shared nodes and their interference.\footnote{Similar problems were encountered in an attempt to provide small specifications for a doubly-linked list implementation of a concurrent tree in~\cite{abstract-connectivity}.} Now
