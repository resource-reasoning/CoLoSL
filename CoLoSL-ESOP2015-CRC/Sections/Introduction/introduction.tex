...
on CAP reasoning (both the unnatural old style in~\cite{cap-ecoop10} and the more natural
modern style introduced  in TaDA~\cite{tada}) in that our small
...
(SCSL)~\cite{scsl-esop14} of Navevski {\em et al.}, which has a different notion
